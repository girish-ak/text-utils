...
export default function Texttools(props) {
    ...
    return (
        <>
            <div className="container my-5 col-md-6 mx-4" style={{color: props.mode==='dark'?'white':'black'}}>
                <div className="mb-3">
                    <h1>{props.heading}</h1>
            ...
            <div className="container my-3 mx-4" style={{color: props.mode==='dark'?'white':'black'}}>
            <h1>Your Text Summary</h1>
            <p><h5>{text.split(" ").length} words & {text.length} characters</h5></p>
